  ...
  return {
    ...
    contents: phantom.callback(function (pageNum, numPages) {
      ...
      return (html || o.default || c.default || '')
          .replace(/\[\[#watermark]]/g, '<div style="position: absolute;width: 100%;height: 100%;left: 0;top: 20rem;font-size: 8rem;color: rgba(0, 0, 0, 0.1);font-family:arial; z-index: 10000;height:0px;margin-top:0rem;"><div style="-moz-transform: rotate(-45deg);-ms-transform: rotate(-45deg);-webkit-transform: rotate(-45deg);transform: rotate(-45deg);text-align: center;">')
