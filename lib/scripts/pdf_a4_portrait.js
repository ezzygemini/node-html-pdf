  ...
  return {
    ...
    contents: phantom.callback(function (pageNum, numPages) {
      ...
      return (html || o.default || c.default || '')
        ...
        .replace(/{{pages}}/g, numPages) +
        (o[pageNum].watermark || c[pageNum].watermark ||
        o.watermark || c.watermark) || '') + content.styles
    })
  }
}
