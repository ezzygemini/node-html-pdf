  ...
  return {
    ...
    contents: phantom.callback(function (pageNum, numPages) {
      ...
      return (html || o.default || c.default || '')
          .replace(/\[\[#watermark]]/g, '<div style="position: absolute;  width: 100%;  height: 100%;  left: 0;  top: 20rem;  font-size: 10rem;  color: rgba(0, 0, 0, 0.1);  z-index: 1;  padding-top: 5rem;  text-align: center;  font-family: Helvetica, Arial, sans-serif;"><div style="-moz-transform: rotate(-45deg);  -ms-transform: rotate(-45deg);  -webkit-transform: rotate(-45deg);  transform: rotate(-45deg);">')
          .replace(/\[\[\/watermark]]/g, '</div></div>')
...
function definePaperSize (content, options) {
  ...
  if (paper.header && paper.header.height === undefined) paper.header.height = '1mm'
